  ...
  while (!draw) {
    ...
    if (replace1 == cpu1 || replace2 == cpu1 || replace3 == cpu1) {
      ...
      continue;
        ...
        userInput2 = prompt ("가위, 바위, 보 중 하나를 입력해 주세요.");
        replace1 = userInput2.replace("가위","1");
        replace2 = userInput2.replace("바위","2");
        replace3 = userInput2.replace("보","3");

        if (replace1 == cpu1 || replace2 == cpu1 || replace3 == cpu1) {
          alert("제가" + userInput + "를 냈으므로 비겼습니다.");
          break;

        } else if ((replace1 != cpu1 && (cpu1 == 3)) || (replace2 != cpu1 && (cpu1 == 1)) || (replace3 != cpu1 && (cpu1 == 2))) {
            alert("제가" + cpu1 + "를 냈습니다. 묵, 찌, 빠 중 하나를 입력해 주세요");
            continue;
          }
        ...
        userInput3 = prompt ("가위, 바위, 보 중 하나를 입력해 주세요.");
        replace1 = userInput3.replace("가위","1");
        replace2 = userInput3.replace("바위","2");
        replace3 = userInput3.replace("보","3");
